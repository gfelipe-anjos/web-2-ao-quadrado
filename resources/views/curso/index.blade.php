            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>
                        ...
                        @can('delete', $item)
                            <a href="{{route('curso.audit', $item->id)}}" class="btn btn-outline-warning">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#C76E00" class="bi bi-search" viewBox="0 0 16 16">
